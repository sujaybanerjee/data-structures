...
public class FishRescueMain extends GridView {
    ...
    public String getHeaderText() {
        return "Fish Saved: " + this.savedFish;
    }
    ...
    public void buttons(Buttons pressed) {
        ...
        if (this.grid.inBounds(this.hero.getPoint())) {
    ...
    public void rescueFish() {
        ...
        for (LostFish f : new ArrayList<>(followFish)) {
            if (fishHome.getPoint().equals(this.hero.getPoint())) {
                this.missingFish.remove(f);
                this.followFish.remove(f);
                savedFish++;
            }
        }
    }
